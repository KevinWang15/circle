...
!function (a) {
  ...
  a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
    ...
    function d() {
      ...
      if (c || (c = F()), r(), !c.hasClass("fr-active"))if (b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", b.$tb), a.is(":visible")) {
    ...
    function e() {
      ...
      var d = ia.offset().left + ia.outerWidth() / 2, e = ia.offset().top + ia.outerHeight();
    ...
    function i() {
      ...
      if (ua)for (c = 0; c < ua.length; c++)e.indexOf(ua[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(ua[c])]);
      ua = d
    }
    ...
    function m(c) {
      if (ka && ia) {
        ...
        if (!d)return !1;
        var e = ka.data("start-x"), f = d - e, g = ka.data("start-width");
    ...
    function v(c, d, e, f, g) {
      ...
      h.onload = function () {
        ...
        if (f) {
          ...
          var m = "";
          if ("undefined" != typeof e)for (h in e)"link" != h && (m += " data-" + h + '="' + e[h] + '"');
    ...
    function w(c) {
      try {
        ...
        if (b.opts.imageUploadDomain) {
          c = upToQiniu(c, b.opts.imageUploadDomain)
        }
        ;
        var d = a.parseJSON(c);
    ...
    function y(a) {
      ...
      try {
        if (b.opts.imageUploadToS3)if (201 == c) {
          var g = x(e);
          g && v(g, !1, [], a, d || e)
        } else o(pa, d || e); else if (c >= 200 && 300 > c) {
          var h = w(f);
    ...
    function B(c, d, f) {
      ...
      h.addEventListener("load", function () {
        ...
        var l = window.URL.createObjectURL(new Blob([new Uint8Array(i)], { type: "image/jpeg" }));
        if (ia) g = ia; else {
        ...
        if (g.on("load", function () {
          ...
          }), ia) b.edit.on(), b.undo.saveStep(), ia.data("fr-old-src", ia.attr("src")), ia.attr("src", l), g.addClass("fr-uploading"); else {
    ...
    function F() {
      ...
      var e = b.opts.imageInsertButtons.indexOf("imageUpload"),
        g = b.opts.imageInsertButtons.indexOf("imageByURL"), h = "";
      ...
      var j = '<div class="fr-image-progress-bar-layer fr-layer"><h3 class="fr-message">Uploading</h3><div class="fr-loader"><span class="fr-progress"></span></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-back" data-cmd="imageDismissError" tabIndex="2">OK</button></div></div>',
        k = { buttons: d, upload_layer: h, by_url_layer: i, progress_bar: j },
    ...
    function H() {
      ...
      var d = ia.offset().left + ia.width() / 2, e = ia.offset().top + ia.height();
    ...
    function O(a) {
      ...
      if (ia || b.opts.toolbarInline) ia && (d = ia.offset().top + ia.outerHeight()); else {
    ...
    var ia, ja, ka, la, ma = 1, na = 2, oa = 3, pa = 4, qa = 5, ra = 6, sa = 7, ta = {};
  ...
  }, a.FroalaEditor.DefineIcon("insertImage", { NAME: "image" }), a.FroalaEditor.RegisterCommand("insertImage", {
    title: "Insert Image",
    undo: !1,
    focus: !0,
